      ...
      paths: {
        ...
        items: {
          ...
          properties: {
            ...
            trimFraction: { type: 'number', title: 'Trim fraction (trimmedMean only, 0 to 0.5)', default: 0.25 },
            angularSpreadThreshold: { type: 'number', title: 'Angular spread threshold (radians, angular paths only)' },
